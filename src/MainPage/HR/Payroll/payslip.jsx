                    ...
                    <div className="col-sm-6">
                      <div>
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td><strong>Basic Salary</strong> <span className="float-end">$6500</span></td>
                            </tr>
                            <tr>
                              <td><strong>House Rent Allowance (H.R.A.)</strong> <span className="float-end">$55</span></td>
                            </tr>
                            <tr>
                              <td><strong>Conveyance</strong> <span className="float-end">$55</span></td>
                            </tr>
                            <tr>
                              <td><strong>Other Allowance</strong> <span className="float-end">$55</span></td>
                            </tr>
                            <tr>
                              <td><strong>Total Earnings</strong> <span className="float-end"><strong>$55</strong></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <div className="col-sm-6">
                      <div>
                        ...
                        <table className="table table-bordered">
                          <tbody>
                            <tr>
                              <td><strong>Tax Deducted at Source (T.D.S.)</strong> <span className="float-end">$0</span></td>
                            </tr>
                            <tr>
                              <td><strong>Provident Fund</strong> <span className="float-end">$0</span></td>
                            </tr>
                            <tr>
                              <td><strong>ESI</strong> <span className="float-end">$0</span></td>
                            </tr>
                            <tr>
                              <td><strong>Loan</strong> <span className="float-end">$300</span></td>
                            </tr>
                            <tr>
                              <td><strong>Total Deductions</strong> <span className="float-end"><strong>$59698</strong></span></td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
