!(function () {
    ...
    function t() {
        ...
        b &&
            ...
            (b = (b = "/" == location.pathname ? "/index" : location.pathname.substring(1)).substring(b.lastIndexOf("/") + 1)) &&
            ...
            Array.from(document.querySelector("#two-column-menu ul").querySelectorAll("li a")).forEach(function (a) {
                var b = (b = "/" == location.pathname ? "/index" : location.pathname.substring(1)).substring(b.lastIndexOf("/") + 1);
    ...
    function B() {
        ...
        var c,
            a,
            b = "/" == location.pathname ? "/index" : location.pathname.substring(1);
    ...
    function C() {
        var a = "/" == location.pathname ? "/index" : location.pathname.substring(1);
