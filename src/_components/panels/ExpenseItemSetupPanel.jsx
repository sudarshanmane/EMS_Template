            ...
            <div className="row">
              <div className="col">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Expense Item Setup</li>
                </ul>
              </div>
            ...
            <div className="col-sm-12">
              <div className="card mb-0">
                <div className="card-header">
                  <h4 className="card-title mb-0">Expense Item Setup</h4>
                </div>
                <div className="card-body">
                  <div className="table-responsive">
                    ...
                    <Modal
                      title={
                        editItemData
                          ? "Update Expense Item Setup"
                          : "Add Expense Item Setup"
                      }
                    ...
                    >
                      {viewCompanyData ? (
                        <div>
                          ...
                          <p>
                            Account Coding Type:{" "}
                            {viewCompanyData.account_coding_type}
                          </p>
                          <p>Item Category: {viewCompanyData.item_category}</p>
                          <p>
                            Merchant Category Code:{" "}
                            {viewCompanyData.merchant_category_code}
                          </p>
                        </div>
                      ) : (
                        <ExpenseItemSetup
