...
const CardHoldList = () => {
  ...
  const managercardholdSelector = useSelector(
    (state) => state.managerholdResult
  );
  ...
  useEffect(() => {
    if (managercardholdSelector) {
      const allExpense = managercardholdSelector.results.map(
        (element, index) => ({
          srno: index + 1,
          id: element.id,
            ...
            <div className="row">
              <div className="col">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Holded Cards</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-12">
              <div className="card mb-0">
                <div className="card-header">
                  <h4 className="card-title mb-0">Holded Cards</h4>
                </div>
